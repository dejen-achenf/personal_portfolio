  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name, // Maps to {{from_name}}
          from_email: form.email, // Maps to {{from_email}}
          message: form.message, // Maps to {{message}}
          to_name: personalInfo.fullName, // Maps to {{to_name}}
          subject: "Client's Here", // Static subject
        },
